...
## 1. Purpose
This folder contains the data download process and code needed to reproduce the reported area-level and branch-level TDABM analyses. The workflow combines England and Wales Census 2021 data, Scotland Census 2022 data, Geolytix bank-branch records, a postcode-to-LSOA lookup file and a Great Britain boundary file. It then produces two analytical CSV files, exploratory analysis, maps, Ball Mapper graphs and robustness checks.

## 2. Data Source and Website
...
https://spatialdata.gov.scot/geonetwork/srv/eng/catalog.search#/metadata/f6656adf-b720-4612-ad5c-1d13eae94c8b
